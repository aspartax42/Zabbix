...
wget https://repo.zabbix.com/zabbix/5.4/ubuntu/pool/main/z/zabbix-release/zabbix-release_5.4-1+ubuntu$(cat /etc/issue | cut -c 8-12)_all.deb
...
dpkg -i zabbix-release_5.4-1+ubuntu$(cat /etc/issue | cut -c 8-12)_all.deb
