...
# Récupération du paquet Zabbix 5.4
cd /tmp

wget https://repo.zabbix.com/zabbix/5.4/debian/pool/main/z/zabbix-release/zabbix-release_5.4-1+debian$(cat /etc/issue | cut -c 18-19)_all.deb
...
dpkg -i zabbix-release_5.4-1+debian$(cat /etc/issue | cut -c 18-19)_all.deb
