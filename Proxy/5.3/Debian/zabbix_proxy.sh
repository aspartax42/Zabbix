...
wget https://repo.zabbix.com/zabbix/5.3/debian/pool/main/z/zabbix-release/zabbix-release_5.3-1+debian$(cat /etc/issue | cut -c 18-19)_all.deb
...
dpkg -i zabbix-release_5.3-1+debian$(cat /etc/issue | cut -c 18-19)_all.deb
