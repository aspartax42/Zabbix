...
# Récupération du paquet Zabbix 5.3
cd /tmp

wget https://repo.zabbix.com/zabbix/5.3/raspbian/pool/main/z/zabbix-release/zabbix-release_5.3-1+debian$(cut -d"." -f1 /etc/debian_version)_all.deb
...
dpkg -i zabbix-release_5.3-1+debian$(cut -d"." -f1 /etc/debian_version)_all.deb
