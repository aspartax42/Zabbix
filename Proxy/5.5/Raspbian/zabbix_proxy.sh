...
# Récupération du paquet Zabbix 5.5
cd /tmp

wget https://repo.zabbix.com/zabbix/5.5/raspbian/pool/main/z/zabbix-release/zabbix-release_5.5-1+debian$(cut -d"." -f1 /etc/debian_version)_all.deb
...
dpkg -i zabbix-release_5.5-1+debian$(cut -d"." -f1 /etc/debian_version)_all.deb
