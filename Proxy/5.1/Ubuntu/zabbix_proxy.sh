...
wget https://repo.zabbix.com/zabbix/5.1/ubuntu/pool/main/z/zabbix-release/zabbix-release_5.1-1+ubuntu$(cat /etc/issue | cut -c 8-12)_all.deb
...
dpkg -i zabbix-release_5.1-1+ubuntu$(cat /etc/issue | cut -c 8-12)_all.deb
