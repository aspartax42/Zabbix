...
# Récupération du paquet Zabbix 5.2
cd /tmp

wget https://repo.zabbix.com/zabbix/5.2/debian/pool/main/z/zabbix-release/zabbix-release_5.2-1+debian$(cat /etc/issue | cut -c 18-19)_all.deb
...
dpkg -i zabbix-release_5.2-1+debian$(cat /etc/issue | cut -c 18-19)_all.deb
